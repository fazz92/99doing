 ...
 *   `angular-animate.js`
 *
 * This contains the AngularJS library
 * plus any listed libraries dependent on the core library.
 *
 */
 ...
 * @example Example that demonstrates basic bindings via ngClass directive.
   <example>
     <file name="index.html">
       ...
       <input type="text" ng-model="style" placeholder="Type: bold strike red" ng-placeholder>
       <hr>
